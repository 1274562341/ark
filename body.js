document.write(`
<span class="mytip">免费IGG脚本-脚本初始化报错请在服务器内部运行-如有其他报错可反馈QQ：1274562341</span>
<div id="app">
  <div id="func" :style="funstyle">
    <el-tabs type="border-card" style="width: 380px; max-height: 500px; overflow: scroll">
      ...
      <el-tab-pane label="替换">
        <p>Tip:使用该功能前重启游戏，可以防止闪退！</p>
        <p>快捷栏有茅草地基和小型木头储物箱(周围建筑多容易闪退)</p>
        <el-row>
          <el-button size="small" @click="searchONE" :disabled="btndisable" type="primary">第一步</el-button>
          <el-button size="small" @click="searchTWO" :disabled="btndisable" type="primary">第二步</el-button>
          <el-button size="small" @click="showsgbp = !showsgbp" type="danger">2000伤害爆破</el-button>
        </el-row>
        <p>快捷替换</p>
        <el-row style="margin-top: 6px">
          <el-select size="small" v-model="valuefz" filterable placeholder="请选择">
        ...
        <el-row style="display: flex">
          ...
          <el-button size="small" @click="inputOne" :disabled="btndisable" type="primary">第一步</el-button>
          <el-input size="small" style="width: 30%" v-model="valuefz2" type="text"></el-input>
          <el-button size="small" @click="inputTwo" :disabled="btndisable" type="primary">第二步</el-button>
        </el-row>
        <p>输入方式(其他物品)：</p>
    ...
    <div class="kjgn" v-show="showsgbp">
      <el-switch v-model="sgbpkg" @change="handleSG">
      </el-switch>
    </div>
  </div>
</div>
